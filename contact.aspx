     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-contact-area">
          ...
          <div class="mu-title">
            <h2>Get in Touch</h2>
            <p>Ready for an amazing experience? That's great! then what you waiting for hurry-up and Register. !!!Happy Learning !!!</p>
          </div>
          <!-- end title -->
    ...
    <div class="mu-footer-bottom">
      <div class="container">
        <div class="mu-footer-bottom-area">
          <p>&copy; All Right Reserved. Designed by <a href="http://www.webmitra.info/" rel="nofollow">webmitra.info</a></p>
        </div>
      </div>
    </div>
    <!-- end footer bottom -->
